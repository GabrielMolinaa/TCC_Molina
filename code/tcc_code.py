...
import Extract_Features as ef  # Aqui é onde as novas funções de feature extraction estão
...
# Carregar e pré-processar os dados como antes
...
svm_param_grid = {
    'C': (0.1, 10.0, 'log-uniform'),  # Parâmetro de regularização
    'gamma': (0.001, 1.0, 'log-uniform'),  # Kernel width para RBF
    'kernel': ['linear', 'rbf']
}
...
# 3. LDA (sem otimização de hiperparâmetros, pois o LDA tem poucos parâmetros para ajustar)
