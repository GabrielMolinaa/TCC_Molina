...
diretorio_janelado = r"D:\Stash\Datasets\db3_janelado\10g"  
diretorio_saida_features = r"D:\Stash\Datasets\db3_features_all\10g"
fs = 2000 
...
def spec(signal):
    f, psd = welch(signal, fs=2000, nperseg=len(signal))
